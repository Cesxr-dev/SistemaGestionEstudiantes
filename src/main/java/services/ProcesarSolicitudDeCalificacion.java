...
public class ProcesarSolicitudDeCalificacion implements IAccion {
    ...
    public void hacer() {
        ...
        calificacionAnterior = estudiante.getCalificaciones().obtenerCalificacion(solicitud.getClave);
        estudiante.getCalificaciones().setCalificacion(solicitud.getClave(), solicitud.getNota());
    }
